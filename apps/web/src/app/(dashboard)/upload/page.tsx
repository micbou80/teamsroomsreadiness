  ...
  return (
    <div className={styles.container}>
      ...
      <Text size={300} className={styles.subtitle}>
        Upload the JSON output from the <code>Invoke-MTRReadinessCheck</code> PowerShell
        module to merge on-premises check results with your latest assessment.
      </Text>
      ...
      {result && (
        <MessageBar intent="success" style={{ marginTop: '16px' }}>
          <MessageBarBody>
            <MessageBarTitle>Merge Complete</MessageBarTitle>
            {result.mergedCount} check{result.mergedCount !== 1 ? 's' : ''} merged
            successfully. Updated assessment score: {result.newOverallScore}/100.
            <br />
            <a href={`/assessment/${result.assessmentId}`}>View updated assessment</a>
          </MessageBarBody>
        </MessageBar>
      )}
    </div>
